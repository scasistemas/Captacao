...
public class DaoCreateDB extends SQLiteOpenHelper{
    private static final String NOME_BD = "captacaoDB";
    private static final int VERSAO_BD = 4;
    private static final String LOG_TAG = "captacaoDB";
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        try
        {
            ...
            ExecutarComandosSQL(db, contexto.getString(R.string.tabela_configgd).split("\n"));
    ...
    private void atualizaDBSQL(SQLiteDatabase db,int oldVsDB, int newVsDB)
    {
        ...
        try
        {
            ...
            if (oldVsDB<4&&newVsDB>=4) {
                db.execSQL(contexto.getString(R.string.tabela_configgd));
        ...
        catch (SQLException e)
        {
            ...
            Log.e("Erro ao atualizar as tabelas e testar os dados", ex.toString());
            throw ex;
        }
        finally
        {
